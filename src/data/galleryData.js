...
export const GALLERY_ITEMS = [
  // --- Everyday Casual & Kaftans ---
  {
    id: 1,
    title: 'Indigo Teal Linen Kaftan',
    category: 'Everyday Casual',
    image: '/gallery/indigo-teal-kaftan.png',
    alt: 'Model wearing Aishka Clothing Indigo Teal Linen Kaftan modest dress',
  ...
  },
  {
    ...
    category: 'Everyday Casual',
    image: '/gallery/terracotta-rust-shift.jpg',
    alt: 'Aishka Clothing warm terracotta rust modest linen shift dress on colonnade',
  ...
  },
  {
    ...
    alt: 'Deep emerald forest green modest linen kaftan by timber poles',
  ...
  },
  {
    ...
    category: 'Everyday Casual',
    image: '/gallery/seafoam-mint-kaftan.jpg',
    alt: 'Pastel seafoam mint modest linen kaftan dress with bamboo backdrop',
  ...
  },
  {
    ...
    alt: 'Sky blue modest linen kaftan at heritage colonial entrance',
  ...
  },
  {
    ...
    category: 'Everyday Casual',
    image: '/gallery/blossom-rose-dress.jpg',
    alt: 'Model in dusty blossom rose pink linen modest dress by arched window',
  ...
  },
  {
    ...
    category: 'Everyday Casual',
    image: '/gallery/midnight-charcoal-dress.jpg',
    alt: 'Model in classic black charcoal minimalist modest dress in courtyard',
  ...
  },
  {
    ...
    category: 'Everyday Casual',
    image: '/gallery/azure-rose-duet.png',
    alt: 'Pair of models wearing sky blue and rose blossom modest linen kaftans',
  ...
  // --- Co-ord Sets ---
  {
    ...
    image: '/gallery/royal-violet-coord.jpg',
    alt: 'Model wearing two-piece royal purple violet modest kaftan and palazzo trousers set',
  ...
  },
  {
    ...
    category: 'Co-ord Sets',
    image: '/gallery/chartreuse-lime-coord.jpg',
    alt: 'Striking chartreuse lime green modest cowl tunic and wide trousers outfit',
  ...
  },
  {
    ...
    category: 'Co-ord Sets',
    image: '/gallery/earthy-sage-coord.jpg',
    alt: 'Model wearing muted olive sage green modest two-piece set at courtyard doorway',
  ...
  },
  {
    ...
    category: 'Co-ord Sets',
    image: '/gallery/berry-crimson-coord.jpg',
    alt: 'Rich berry crimson cowl kaftan top and matching wide trousers against exposed brick',
  ...
  },
  {
    ...
    category: 'Co-ord Sets',
    image: '/gallery/navy-midnight-coord.jpg',
    alt: 'Flowing midnight navy blue modest tunic and palazzo set by arched wooden window',
  ...
  },
  {
    ...
    category: 'Co-ord Sets',
    image: '/gallery/chartreuse-veranda-coord.jpg',
    alt: 'Chartreuse lime modest ensemble among classic veranda architectural pillars',
  ...
  // --- Checks & Stripes ---
  {
    ...
    image: '/gallery/peach-gingham-midi.jpg',
    alt: 'Model in warm apricot peach gingham modest midi dress by carved teak door',
  ...
  },
  {
    ...
    category: 'Checks & Stripes',
    image: '/gallery/sunshine-yellow-gingham.jpg',
    alt: 'Radiant yellow and white check modest sleeveless A-line dress in garden courtyard',
  ...
  },
  {
    ...
    category: 'Checks & Stripes',
    image: '/gallery/pink-candy-stripe-dress.jpg',
    alt: 'Model in pink and white candy striped buttoned shirt dress in lush garden',
  ...
  },
  {
    ...
    category: 'Checks & Stripes',
    image: '/gallery/rose-gingham-arch-midi.jpg',
    alt: 'Model in rose pink gingham tiered dress beside arched wooden window',
  ...
  },
  {
    ...
    category: 'Checks & Stripes',
    image: '/gallery/aqua-sky-gingham-midi.jpg',
    alt: 'Turquoise aqua blue gingham check modest dress by wooden window',
  ...
  },
  {
    ...
    category: 'Checks & Stripes',
    image: '/gallery/mustard-navy-plaid-dress.jpg',
    alt: 'Mustard yellow and dark navy tartan plaid modest long-sleeve dress',
  ...
  },
  {
    ...
    category: 'Checks & Stripes',
    image: '/gallery/botanical-green-gingham.jpg',
    alt: 'Forest green gingham check modest dress against red brick wall and lawn',
  ...
  },
  {
    ...
    category: 'Checks & Stripes',
    image: '/gallery/harmonious-gingham-duet.jpg',
    alt: 'Two models seated together wearing rose and aqua gingham check dresses',
  ...
  // --- Linen Shirt Dresses ---
  {
    ...
    image: '/gallery/mint-celadon-shirt-dress.jpg',
    alt: 'Model wearing stylish oversized mint green collared shirt dress with teal sling bag',
  ...
  },
  {
    ...
    category: 'Linen Shirt Dresses',
    image: '/gallery/oatmeal-sand-shirt-dress.jpg',
    alt: 'Neutral unbleached oatmeal sand linen oversized shirt dress by green climbing ivy',
  ...
  },
  {
    ...
    category: 'Linen Shirt Dresses',
    image: '/gallery/blush-rose-shirt-dress.jpg',
    alt: 'Model in powder blush pink modest button-down shirt dress in verandah garden',
